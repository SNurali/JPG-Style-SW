...
CREDENTIALS_FILE = os.path.expanduser("~/.wg_credentials")
...
class WireGuardManager:
    def __init__(self, root):
        self.root = root
        self.root.title("WireGuard Manager")
    ...
    def open_server_terminal(self):
        ...
        try:
            ssh_script = os.path.expanduser("~/ssh_to_server.sh")
