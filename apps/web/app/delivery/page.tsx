...
export const metadata: Metadata = {
  ...
  description:
    'Доставка автохимии SmartWash по Ташкенту в день заказа. Бесплатная доставка от 500 000 сум. Курьерская доставка и самовывоз. Доставка в регионы Узбекистана.',
    ...
    <div className="min-h-[60vh] px-4 py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="glass-card p-8 space-y-6 text-text-muted leading-relaxed">
          ...
          <p>
            Обычно доставка занимает от 1 до 6 часов с момента подтверждения заказа. В редких
            случаях (высокая загрузка, погодные условия) срок может быть увеличен до 24 часов.
          </p>
