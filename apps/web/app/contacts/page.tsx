...
export const metadata: Metadata = {
  ...
  description:
    'Свяжитесь с JPG Style SmartWash: ☎ +998 99 030 99 86, +998 50 104 00 26. Telegram: @JPGSTYLE_SMARTWASH. Ташкент, Узбекистан. Пн-Пт 09:00-19:00, Сб 10:00-17:00.',
          ...
          <div className="glass-card p-6 space-y-4">
            ...
            <div className="pt-4 border-t border-white/[0.08]">
              ...
              <p className="text-sm text-text-muted">
                Для автомоек, детейлинг-центров и магазинов — специальные цены при заказе от 10
                единиц. Звоните для обсуждения условий.
              </p>
            </div>
          </div>
        </div>
