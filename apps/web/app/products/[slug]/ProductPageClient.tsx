          ...
          <div className="glass-card aspect-square overflow-hidden relative">
            ...
            <div className="absolute top-4 left-4 flex flex-col gap-2 z-10">
              {product.isBestseller && (
                <span className="badge-bestseller text-sm">🔥 {t('bestsellers.hitLabel')}</span>
              )}
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mb-6">
            <div className="flex">
              {[...Array(5)].map((_, i) => (
                <svg
                  key={i}
                  className={`w-5 h-5 ${i < Math.floor(product.rating) ? 'text-yellow-400' : 'text-white/10'}`}
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-4">
            <div className="flex items-center glass-card">
              ...
              <span className="px-4 py-3 font-semibold text-white min-w-[3rem] text-center">
                {quantity}
              </span>
              <button
