...
export const metadata: Metadata = {
  ...
  description:
    'JPG Style SmartWash — производитель профессиональной автохимии премиум-класса в Узбекистане. Собственное производство, контроль качества, доступные цены от 22 500 сум. Доставка по Ташкенту.',
    ...
    <div className="min-h-[60vh] px-4 py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="glass-card p-8 space-y-6 text-text-muted leading-relaxed">
          ...
          <p>
            Дать профессионалам и автолюбителям доступ к качественной автохимии по честным ценам. Мы
            уверены: каждая машина заслуживает идеального ухода.
          </p>
          ...
          <p>
            Качество. Честность. Забота о клиенте. Мы не гонимся за количеством — каждый продукт
            проходит проверку, прежде чем попасть на полку.
          </p>
